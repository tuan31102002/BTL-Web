...
export default function Footer() {
    return (
    <div>
            <div style="background-color:#2E282E ;" />
                    ...
                    <div className="col-6">
                        <div className="input-group">
                            ...
                            <span className="input-group-append">
                                <button style="background-color: #03a9f4" className="btn btn-default" type="submit"
         ...
         <div style="background-color:#000000fa;padding: 10px;">
        <p style="text-align: center;">© Bản quyền thuộc về Nhà sách Tiến Thọ | Cung cấp bởi Sapo<img src="image/logo3.png" alt="" /></p>
